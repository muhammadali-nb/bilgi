...
<template>
  <div class="bid">
    <div class="bid__statistic-cards">
      ...
      <StatisticCard value="100 000" title="Новые" severity="error" />
      <StatisticCard value="100 000" title="Новые" severity="error" />
      <StatisticCard value="100 000" title="Новые" severity="default" />
      <StatisticCard value="100 000" title="Новые" severity="default" />
      <StatisticCard value="100 000" title="Новые" severity="success" />
    </div>
    <div class="bid__statistic-filters">
      <Select placeholder="Дата  _ _  _ _  _ _ _ _" />
      <Select placeholder="Статус ______" />
    </div>
    <DataTable :value="bidData" :rows="10" paginator paginator-template="PrevPageLink PageLinks NextPageLink RowsPerPageDropdown">
